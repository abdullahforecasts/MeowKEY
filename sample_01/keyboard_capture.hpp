...
//         std::string line;
//         std::string current_handler;
        
//         while (std::getline(devices_file, line)) {
//             if (line.find("H: Handlers=") != std::string::npos) {
//                 size_t pos = line.find("event");
//                 if (pos != std::string::npos) {
//                     current_handler = "/dev/input/" + line.substr(pos, line.find(' ', pos) - pos);
//                 }
//             }
//             if (line.find("EV=120013") != std::string::npos && !current_handler.empty()) {
//                 if (isKeyboardDevice(current_handler)) {
//                     keyboard_device_ = current_handler;
//                     std::cout << "Found keyboard device: " << current_handler << std::endl;
//                     return;
//                 }
//             }
//         }

//         throw std::runtime_error("Could not find keyboard device");
//     }
...
//         close(fd);
//         return (evbit & (1 << EV_KEY)) && (evbit & (1 << EV_KEY));
//     }

//     void captureLoop() {
//         int fd = open(keyboard_device_.c_str(), O_RDONLY);
//         if (fd < 0) {
//             std::cerr << "Failed to open keyboard device: " << keyboard_device_ << std::endl;
//             return;
//         }
